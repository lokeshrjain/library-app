...
public class JsonReader {
	...
	public static JsonObject readJosnAsObject(final String json) throws InvalidJsonException {
		return readJsonAs(json, JsonObject.class);
	}

	public static JsonArray readJosnAsArray(final String json) throws InvalidJsonException {
	...
	public static <T> T readJsonAs(final String json, final Class<T> jsonClass) throws InvalidJsonException {
		if (json == null || json.trim().isEmpty()) {
			throw new InvalidJsonException("json can't be null");
		}
		try {
	...
	private static boolean isJsonElementNull(final JsonElement property) {
